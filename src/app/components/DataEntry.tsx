    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Record water quality measurements and treatment data
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter all measurement values from the current sampling session
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.location} onValueChange={(value) => handleChange('location', value)}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="reservoir-1">Reservoir 1</SelectItem>
                      <SelectItem value="reservoir-2">Reservoir 2</SelectItem>
                      <SelectItem value="distribution-point-a">Distribution Point A</SelectItem>
                      <SelectItem value="distribution-point-b">Distribution Point B</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Standard acceptable ranges for water quality parameters</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            <div className="p-3 bg-blue-50 rounded-lg">
              <p className="text-sm text-gray-600">pH Level</p>
              <p className="font-semibold">6.5 - 8.5 pH</p>
            </div>
            <div className="p-3 bg-green-50 rounded-lg">
              <p className="text-sm text-gray-600">Turbidity</p>
              <p className="font-semibold">{'< 1.0 NTU'}</p>
            </div>
            <div className="p-3 bg-cyan-50 rounded-lg">
              <p className="text-sm text-gray-600">Chlorine</p>
              <p className="font-semibold">0.5 - 3.0 mg/L</p>
            </div>
          </div>
        </CardContent>
      </Card>
