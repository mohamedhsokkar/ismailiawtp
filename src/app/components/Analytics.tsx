...
const generateHistoricalData = (days: number) => {
  ...
  for (let i = days - 1; i >= 0; i--) {
    ...
    data.push({
      ...
      ph: 7.0 + Math.random() * 0.8 - 0.2,
      turbidity: 0.5 + Math.random() * 1.0,
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Detailed water quality trends and statistical analysis
          </p>
        </div>
        <div className="w-40">
      ...
      <Tabs defaultValue="trends" className="space-y-6">
        ...
        <TabsContent value="trends" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Historical pH measurements over time</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Chlorine and turbidity levels comparison</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={350}>
                <LineChart data={data}>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Temperature variations</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Water flow measurements</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={data}>
                    ...
                    <Tooltip />
                    <Legend />
                    <Bar dataKey="flowRate" fill="#8b5cf6" name="Flow Rate (L/min)" />
                  </BarChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
        ...
        <TabsContent value="compliance" className="space-y-6">
              ...
              <CardContent className="space-y-6 pt-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                    <div>
                      <p className="text-sm text-gray-600">Compliant Readings</p>
                  ...
                  <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-2xl font-semibold text-yellow-700">5%</p>
                    </div>
                  </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Parameter Compliance Details</CardTitle>
              <CardDescription>Individual parameter compliance rates</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {[
                  ...
                  { param: 'Temperature', compliance: 100, target: '< 25°C' },
                ].map((item) => (
        ...
        <TabsContent value="efficiency" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Treatment Process Efficiency</CardTitle>
              <CardDescription>Performance of each treatment stage</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={350}>
                <BarChart data={treatmentEfficiency} layout="vertical">
                  <CartesianGrid strokeDasharray="3 3" />
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Water Recovery</CardTitle>
                <CardDescription>Process efficiency</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
