...
export function Layout() {
  ...
  const navItems = [
    { to: '/lab', label: 'Lab', icon: FlaskConical, feature: 'lab' as const },
    { to: '/assets', label: 'Assets', icon: Factory, feature: 'assets' as const },
    { to: '/users', label: 'Users', icon: UserCircle2, feature: 'user-management' as const },
