  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            <CardTitle>pH Levels (Last 7 Days)</CardTitle>
            <CardDescription>Daily pH monitoring results</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Flow Rate (Last 7 Days)</CardTitle>
            <CardDescription>Water flow rate in liters per minute</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
